#include "stdafx.h"
#include "BattleIdle.h"
#include "Look.h"
#include "MessageBlock.h"
#include "MyButton.h"

CBattleIdle::CBattleIdle()
{
}
...
void CBattleIdle::Initialize(void)
{
...
void CBattleIdle::Update(void)
{
    CObjMgr::Get_Instance()->Update();
}

void CBattleIdle::Late_Update(void)
{
    CObjMgr::Get_Instance()->Late_Update();
}

void CBattleIdle::Render(HDC hDC)
{
