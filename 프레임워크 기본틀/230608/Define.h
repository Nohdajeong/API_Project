...
enum OBJID {	TEXTBOX, PLAYER, NPC, STAGE_OBJ, WALL,
				BATTLE_PLAYER, PLAYER_STATE, MONSTER_STATE, 
				ATTACK, MONSTER, BULLET, MONSTER_MENTION,
...
enum SCENEID
{
	...
	BOSS_MATCH, BOSS_IDLE, BOSS_ATTACK, BOSS_PHASE, BOSS_ACT, BOSS_ITEM, BOSS_MERCY, BOSS_DIE,
	GAMEOVER, ENDING,
	SCENE_END };
